...
"moby-containerd-shim-systemd": [DISTRO=#enumLinuxDistros]: {
    binaries: [
...
"moby-containerd-shim-systemd": [DISTRO=#enumDebDistros]: {
    runtimeDeps: [
  "systemd (>= 239)",
  "moby-containerd (>= 1.6)"
]
...
"moby-containerd-shim-systemd": [DISTRO=#enumRPMDistros]: {
    runtimeDeps: [
  "/bin/sh",
...
"moby-containerd-shim-systemd": windows: {
    runtimeDeps: []
    recommends: []
    conflicts: []
    replaces: []
